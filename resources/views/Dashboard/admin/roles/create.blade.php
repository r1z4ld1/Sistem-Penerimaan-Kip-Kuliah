...
@section('content')
    ...
    <div class="mb-6 lg:mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-slate-500 mt-1.5 text-sm lg:text-base">
                Tambahkan tingkatan role baru untuk sistem kontrol akses.
            </p>
        </div>
    ...
    <div class="max-w-2xl bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <form action="{{ route('admin.roles.store') }}" method="POST" class="p-6 md:p-8 space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: admin_gudang"

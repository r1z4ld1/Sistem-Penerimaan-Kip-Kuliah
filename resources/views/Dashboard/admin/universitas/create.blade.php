...
@section('content')
    ...
    <div class="mb-6 lg:mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-slate-500 mt-1.5 text-sm lg:text-base">
                Daftarkan institusi pendidikan tinggi atau universitas baru ke dalam sistem.
            </p>
        </div>
    ...
    <div class="max-w-4xl bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <form action="{{ route('admin.universitas.store') }}" method="POST" class="p-6 md:p-8">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama_universitas" value="{{ old('nama_universitas') }}"
                        placeholder="Masukkan nama resmi universitas (contoh: Universitas Indonesia)"
